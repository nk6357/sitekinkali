    ...
    >
      ...
      >
        <button
          ...
          type="button"
          onClick={onClose}
          className="absolute right-3 top-3 z-20 flex h-11 w-11 items-center justify-center rounded-full border-2 border-brand-900 bg-brand-50/95 font-heading text-3xl leading-none text-brand-900 shadow-md transition-transform duration-200 hover:scale-105 focus:outline-none sm:right-5 sm:top-5"
